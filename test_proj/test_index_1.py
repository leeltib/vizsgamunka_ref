...
if tcA007_run == True:
    ...
    def test_t_case007():
        ...
        import subprocess
        # Set git config...
        subprocess.Popen(["git", "config", "--global", "leeltib", "github-actions[bot]"])
        subprocess.Popen(["git", "config", "--global", "leeltib@gmail.com", "41898282+github-actions[bot]@users.noreply.github.com"])
        # Push to remote...
